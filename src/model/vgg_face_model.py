...
class VGGFaceModel:
            ...
            if not os.path.exists(result_directory):
                ...
                if self.force_update:
                    ...
                    if (self.embedding_type == 'basic_double_detection' and os.path.exists(
                        ...
                        print("[Results already exists. Existing results will not be updated (maybe results are from "
                              "other model like Facenet)]")
                        return 0
    ...
    def prepare_face(face, directory):
        ...
        return numpy.asarray(Image.fromarray(face_matrix).resize((224, 224)), 'float32').reshape((1, 224, 224, 3))
